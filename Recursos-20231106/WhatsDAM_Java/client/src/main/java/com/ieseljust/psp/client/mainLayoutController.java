...
import com.ieseljust.psp.client.communications.communicationManagerException;
...
public class mainLayoutController {
    ...
    private void enviarMisstge() throws communicationManagerException, IOException {
